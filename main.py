...
train_files = glob.glob("/Users/preetham/PycharmProjects/Audio_Classification/processed_audio/*.wav")
test_files = glob.glob("/Users/preetham/PycharmProjects/Audio_Classification/Test/*.wav")
train_labels = pd.read_csv("/Users/preetham/PycharmProjects/Audio_Classification/train.csv")

# In[4]:


file_to_label = {"/Users/preetham/PycharmProjects/Audio_Classification/RW_AUDIO_DATA_2019_Update/JUNE_01_PHANTOMS/" + k: v for k, v in zip(train_labels.fname.values, train_labels.label.values)}
...
model.fit_generator(train_generator(tr_files), steps_per_epoch=len(tr_files) // batch_size, epochs=20,
                    validation_data=train_generator(val_files), validation_steps=1,
